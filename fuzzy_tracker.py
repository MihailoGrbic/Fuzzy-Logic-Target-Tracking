...
class FuzzyTracker():
    ...
    def updateTrackerPos(self, target_pos):
        ...
        self.absolute_speed += 1.5 * np.array([x_acc, y_acc])
...
def fuzzify_distance(crisp_value):
    fuzzy_dist = {
        ...
        'med negative': trapezoid(-200, -100, -50, -30)(crisp_value),
        'little negative': trapezoid(-50, -30, -10, 0)(crisp_value),
        'zero': trapezoid(-10, 0, 0, 10)(crisp_value),
        'little positive': trapezoid(0, 10, 30, 50)(crisp_value),
        'med positive': trapezoid(30, 50, 100, 200)(crisp_value),
...
def fuzzify_speed(crisp_value):
    fuzzy_speed = {
        ...
        'med negative': trapezoid(-4, -3, -1, -0.5)(crisp_value),
        'little negative': trapezoid(-1, -0.5, -0.25, 0)(crisp_value),
        'zero': trapezoid(-0.25, 0, 0, 0.25)(crisp_value),
        'little positive': trapezoid(0, 0.25, 0.5, 1)(crisp_value),
        'med positive': trapezoid(0.5, 1, 3, 4)(crisp_value),
...
def fuzzy_acceleration():
    fuzzy_acc = {
        'very negative': trapezoid(-0.75, -0.5, -0.5, -0.3),
        'med negative': trapezoid(-0.5, -0.3, -0.3, -0.05),
        'little negative': trapezoid(-0.3, -0.05, -0.05, 0),
        'zero': trapezoid(-0.05, 0, 0, 0.05),
        'little positive': trapezoid(0, 0.05, 0.05, 0.3),
        'med positive': trapezoid(0.05, 0.3, 0.3, 0.5),
        'very positive': trapezoid(0.3, 0.5, 0.5, 0.75),
    }
    return fuzzy_acc
